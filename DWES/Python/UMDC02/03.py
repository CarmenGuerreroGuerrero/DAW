print("Ejercicio 03. Escribir una función que dados cuatro números, devuelva el mayor producto de dos de ellos.\nPor ejemplo, si recibe los números 1, 5, -2, -4 debe devolver 8, que es el producto más grande que se puede obtener entre ellos.")
def NumeroMayor(n1,n2,n3,n4):
    mayor = n1 * n2
    n1n3 = n1 * n3
    n1n4 = n1 * n4
    n2n3 = n2 * n3
...
while Compara:
        ...
        Compara = False
print("El mayor producto entre ellos es: ", NumeroMayor(n1,n2,n3,n4))